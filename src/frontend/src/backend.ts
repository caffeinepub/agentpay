...
import type { DepositRequest as _DepositRequest, DepositStatus as _DepositStatus, Transaction as _Transaction, UserRole as _UserRole, WithdrawalRequest as _WithdrawalRequest, WithdrawalStatus as _WithdrawalStatus, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBankAccount(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBankAccount(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async creditCommission(arg0: Principal, arg1: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.creditCommission(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listBankAccounts(): Promise<Array<BankAccount>> {
        if (this.processError) {
            try {
    ...
    async listDeposits(): Promise<Array<DepositRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.listDeposits();
    ...
    async listWithdrawals(): Promise<Array<WithdrawalRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.listWithdrawals();
    ...
    async register(arg0: Phone, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitDeposit(arg0: number, arg1: string, arg2: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDeposit(arg0, arg1, to_candid_opt_n26(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitWithdrawal(arg0: number, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitWithdrawal(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DepositRequest_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DepositRequest): DepositRequest {
    return from_candid_record_n21(_uploadFile, _downloadFile, value);
}
function from_candid_DepositStatus_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DepositStatus): DepositStatus {
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        transactionType: from_candid_variant_n15(_uploadFile, _downloadFile, value.transactionType),
...
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_DepositStatus_n22(_uploadFile, _downloadFile, value.status),
        screenshotBlobId: value.screenshotBlobId,
        note: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.note)),
        createdAt: value.createdAt,
        user: value.user,
        amount: value.amount
    };
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "withdrawalRequest" in value ? {
        __kind__: "withdrawalRequest",
        withdrawalRequest: from_candid_WithdrawalRequest_n16(_uploadFile, _downloadFile, value.withdrawalRequest)
    } : "depositRequest" in value ? {
        __kind__: "depositRequest",
        depositRequest: from_candid_DepositRequest_n20(_uploadFile, _downloadFile, value.depositRequest)
    } : value;
}
...
function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DepositRequest>): Array<DepositRequest> {
    return value.map((x)=>from_candid_DepositRequest_n20(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WithdrawalRequest>): Array<WithdrawalRequest> {
